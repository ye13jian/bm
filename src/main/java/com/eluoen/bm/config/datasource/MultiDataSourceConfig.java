 ...
 */
package com.eluoen.bm.config.datasource;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "bm.muti-datasource", name = "open", havingValue = "true")
@EnableTransactionManagement(order = 2, proxyTargetClass = true)
@MapperScan(basePackages = {"com.eluoen.bm.modular.*.dao", "com.eluoen.bm.multi.mapper"})
public class MultiDataSourceConfig {
     ...
     */
    @Bean
    @ConfigurationProperties(prefix = "bm.muti-datasource")
